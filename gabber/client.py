...
from typing import Iterable, List, Any, Callable, Coroutine, Iterable, Mapping, Union
...
class RetryTransport(httpx.AsyncBaseTransport, httpx.BaseTransport):
    """
    From: https://github.com/encode/httpx/issues/108#issuecomment-1434439481
...
class Client:
    ...
    def _get(self, *args, skip_sess_refresh=False, **kwargs):
        ...
        retry_tx = RetryTransport(
            httpx.HTTPTransport(),
            retry_status_codes=[413, 429, 503, 403, 500, 502, 523, 520],
        )

        retries = {"all://": retry_tx}

        s = httpx.Client(mounts=retries)
